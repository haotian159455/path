package com.fh.shop.controller.classs;

import com.fh.shop.biz.classs.IClassService;
...
public ServerResponse updateClass(ClassPo classPo){
    ...
    @ResponseBody
    public ServerResponse queryClass(Long id){
        List<ClassPo> classPoList = classService.queryClass(id);
        return  ServerResponse.success(classPoList);
    }
